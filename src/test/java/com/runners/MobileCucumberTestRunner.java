...
@CucumberOptions(
    features = {"src/test/resources/features/mobile/MobileDemo.feature"},  // Run only UI-related features
...
public class MobileCucumberTestRunner extends AbstractTestNGCucumberTests {
